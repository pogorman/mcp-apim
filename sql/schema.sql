...
CREATE TABLE rtt_summary (
    ...
    cash_consideration      FLOAT NULL,
    other_consideration     FLOAT NULL,
    total_consideration     FLOAT NULL,
    assessed_value          FLOAT NULL,
    common_level_ratio      FLOAT NULL,
    fair_market_value       FLOAT NULL,
    state_tax_amount        FLOAT NULL,
    state_tax_percent       FLOAT NULL,
    local_tax_amount        FLOAT NULL,
    local_tax_percent       FLOAT NULL,
